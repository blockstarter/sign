...
(function(){
  var Web3, program, ref$, blue, yellow, BigNumber, b, web3, abi, contractFactory, result, amount, print;
  Web3 = require('web3');
  ...
  result = program.to != null
    ? (console.log("Input"), amount = b(program.amount).times(Math.pow(10, 18)), console.log(blue("To"), program.to), console.log(blue("Amount"), program.amount), console.log(blue("Data"), program.data), contractFactory.execute.getData(program.to, amount.toString(), program.data))
    : program.confirm_hash != null ? (console.log("Input"), console.log(blue("Hash"), program.confirm_hash), contractFactory.confirm.getData(program.confirm_hash)) : '';
  if (result.length === 0) {
    ...
    print = function(field, value){
      return console.log(field, ":", yellow(value));
    };
